...
void FramebufferCache::setFrameBufferSize(const uvec2& frameBufferSize) {
...
void FramebufferCache::createPrimaryFramebuffer() {
    ...
    auto width = _frameBufferSize.x;
    auto height = _frameBufferSize.y;
...
gpu::FramebufferPointer FramebufferCache::getFramebuffer() {
    if (_cachedFramebuffers.isEmpty()) {
        _cachedFramebuffers.push_back(gpu::FramebufferPointer(gpu::Framebuffer::create(gpu::Element::COLOR_RGBA_32, _frameBufferSize.x, _frameBufferSize.y)));
    }
