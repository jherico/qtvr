...
class PluginContainerProxy : public QObject, PluginContainer {
    ...
    virtual void addMenuItem(PluginType type, const QString& path, const QString& name, std::function<void(bool)> onClicked, bool checkable = false, bool checked = false, const QString& groupName = "") override;
    virtual void removeMenuItem(const QString& menuName, const QString& menuItem) override;
    virtual void clearDisplayPluginItems() override;
    virtual void clearInputPluginItems() override;
    ...
    virtual QOpenGLContextWrapper* getPrimaryContext() override;
